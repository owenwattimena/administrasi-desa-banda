...
<body class="px-5">
    ...
    <h4 class="text-center" style="margin-top:0;">NO. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /SKBM/NA.R/ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; / {{ date('Y') }}</h4>
    <p class="mt-3">
        Yang bertanda tangan dibawah ini Kepala Pemerintah Negeri Administratif Rajawali menerangkan bahwa :
    </p>
    <div class="row">
        <div class="col-12">
    ...
    <p class="mt-3">Adalah benar yang bersangkutan diatas merupakan Penduduk Negeri Administratif Rajawali Kecamatan Banda Kabupaten Maluku Tengah, dan sepengetahuan kami serta catatan pada kami bahwa benar yang bersangkutan sampai saat ini belum pernah menikah.</p>
    <p class="mt-3">Demikian surat keterangan ini dibuat dan di berikan kepada yang bersangkutan untuk dipergunakan  sebagaimana mestinya.</p>
